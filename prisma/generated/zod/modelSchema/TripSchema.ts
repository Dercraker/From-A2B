...
export const TripOptionalDefaultsSchema = TripSchema.merge(z.object({
...
export type TripOptionalDefaultsWithRelations = z.infer<typeof TripOptionalDefaultsSchema> & TripOptionalDefaultsRelations

export const TripOptionalDefaultsWithRelationsSchema: z.ZodType<TripOptionalDefaultsWithRelations> = TripOptionalDefaultsSchema.merge(z.object({
