...
import { RoadWithRelationsSchema, RoadOptionalDefaultsWithRelationsSchema } from './RoadSchema'
import type { RoadWithRelations, RoadOptionalDefaultsWithRelations } from './RoadSchema'
import { TaskWithRelationsSchema, TaskOptionalDefaultsWithRelationsSchema } from './TaskSchema'
import type { TaskWithRelations, TaskOptionalDefaultsWithRelations } from './TaskSchema'
import { FileWithRelationsSchema, FileOptionalDefaultsWithRelationsSchema } from './FileSchema'
import type { FileWithRelations, FileOptionalDefaultsWithRelations } from './FileSchema'
...
export const StepOptionalDefaultsSchema = StepSchema.merge(z.object({
...
export type StepOptionalDefaultsWithRelations = z.infer<typeof StepOptionalDefaultsSchema> & StepOptionalDefaultsRelations

export const StepOptionalDefaultsWithRelationsSchema: z.ZodType<StepOptionalDefaultsWithRelations> = StepOptionalDefaultsSchema.merge(z.object({
